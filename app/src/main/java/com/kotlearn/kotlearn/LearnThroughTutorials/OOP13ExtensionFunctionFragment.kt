...
class OOP13ExtensionFunctionFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var btn_previous = rootView.findViewById<Button>(R.id.btn_oop13_previous)
        var btn_next = rootView.findViewById<Button>(R.id.btn_oop13_next)

        btn_next.setOnClickListener{
            transaction.replace(R.id.fragmentUsed, OOP14OperatorOverloadingFragment()).commit()
        }
